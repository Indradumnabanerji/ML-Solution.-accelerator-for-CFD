...
class DeepHPM:    
    ...
    def sol_init(self, t_b, x_b, y_b, w_b,
        ...
        # loss for Solution
        self.sol_loss = tf.reduce_sum(tf.square(self.w_b_tf - self.w_b_pred)) +                         tf.reduce_sum(tf.square(self.sol_f_pred))
...
if __name__ == "__main__": 
    ...
    ### Load Data ###
    data = scipy.io.loadmat('/Users/indradumna/desktop/Tensorflow/cylinder.mat')
...
#    plot_solution(X_data,np.abs(w_pred[:,step]-w_data[:,step]),6)
    ...
    data = scipy.io.loadmat('/Users/indradumna/desktop/Tensorflow/cylinder_vorticity.mat')
    XX = data['XX']
    YY = data['YY']
    WW = data['WW']
    WW[XX**2 + YY**2 < 0.25] = 0
    ...
    plt.savefig('/Users/indradumna/desktop/fig2x.png', dpi=600, facecolor='w',edgecolor='w',
